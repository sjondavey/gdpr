...
3) State 'NONE:' and nothing else in all other cases\n\n\""
        ...
        expected_message = f"You are answering questions for a Controller based only on the sections from the General Data Protection Regulation (GDPR) that are provided. Please use the manual's index pattern when referring to sections: {short_pattern}. You have two options:\n\
1) Answer the question. Preface an answer with the tag 'ANSWER:'. End the answer with 'Reference: ' and a comma separated list of the section you used to answer the question if you used any.\n\
