...
def add_to_index(openai_client, index_df, text, section_reference, source, document, embedding_model, embedding_dimensions):
    ...
    new_df = pd.DataFrame([[section_reference, text, source, document, new_embedding]],columns = ["section_reference", "text", "source", "document", "embedding"])
