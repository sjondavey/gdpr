...
class Concent(Document):
    def __init__(self, path_to_manual_as_csv_file = "./inputs/documents/concent.parquet"):

        reference_checker =  self.ConcentReferenceChecker()
        ...
        if not self.check_columns():
            raise AttributeError(f"The input parquet file for the Concent class does not have the correct column headings")
    ...
    class ConcentReferenceChecker(ReferenceChecker):
        def __init__(self):
